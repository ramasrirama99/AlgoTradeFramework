...
def main():
    ...
    ts = TimeSeries(key=apikey.API_KEY, output_format='csv')
    ti = TechIndicators(key=apikey.API_KEY, output_format='json')
    cc = CryptoCurrencies(key=apikey.API_KEY, output_format='json')
